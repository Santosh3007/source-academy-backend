defmodule Cadet.NotificationsTest do
  ...
  describe "notification_configs" do
    ...
    #   assert_raise Ecto.NoResultsError, fn ->
    #     Notifications.get_notification_config!(notification_config.id)
    #   end
    # end
  ...
  describe "notification_preferences" do
    ...
    #   assert Notifications.get_notification_preference!(notification_preference.id) ==
    ...
    #            Notifications.get_notification_preference!(notification_preference.id)
    # end
  ...
  describe "sent_notifications" do
    ...
    #   assert_raise Ecto.NoResultsError, fn ->
    #     Notifications.get_sent_notification!(sent_notification.id)
    #   end
    # end
